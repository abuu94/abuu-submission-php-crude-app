	...
	<div class="alert alert-success ">
		  ...
		  <form method="POST" action="handler.php">
			  <div class="form-group">
			    <label for="email">Enter Network Name</label>
			    <input type="text" name="name" class="form-control" id="name" value="<?php echo($row["network_name"]);?>">
			  </div>
			  <div class="form-group">
			    <label for="pwd">Enter Headquater Location</label>
			    <input type="text" name="headquater"  class="form-control" id="headquater" value="<?php echo($row["headquater"]);?>">
			  </div>
			   <div class="form-group">
			    <label for="pwd">Enter Website</label>
			    <input type="text" name="website" class="form-control" id="website" value="<?php echo($row["website"]);?>">
			  </div>
			  <input type="text" name="id" class="form-control" id="id" value="<?php echo($row["id"]);?>" hidden="">
